# scaffy — Gemini Instructions

## Project Overview

Bootstraps a .collab collaboration workspace (contracts, kanban, prompts, summaries, audit, and git-management templates) for new or existing projects.
