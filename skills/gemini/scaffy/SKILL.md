---
name: scaffy
description: Bootstrap a .collab/ multi-agent workspace using scaffy, or run session protocols (open/save/close/save-chat/brainstorm/project-plan) for an existing scaffy project.
---
